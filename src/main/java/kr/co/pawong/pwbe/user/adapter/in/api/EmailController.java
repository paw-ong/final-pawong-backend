...
import kr.co.pawong.pwbe.user.adapter.in.api.dto.request.EmailVerificationRequest;
...
public class EmailController {
    ...
    public ResponseEntity<Boolean> verificationEmail(@RequestBody EmailVerificationRequest request) {
